...
const Login = () => {
  ...
  return (
    <div className="relative flex overflow-hidden">
      <select className="select bg-transparent text-white focus:text-black focus:bg-white active:bg-white border-0 absolute z-10 " onChange={(e)=>{setLanguage(e.target.value)}}>
        <option selected>
          English
        </option>
        <option>简体中文</option>
      ...
      <div
        ...
        className="flex absolute flex-row-reverse w-full p-2 space-x-2"
      >
      ...
      <div className="flex min-h-full flex-1 flex-col justify-center px-6 pt-5">
        ...
        <div className="mt-10 sm:mx-auto sm:w-full sm:max-w-sm">
          ...
          <p className="mt-10 text-center text-sm text-gray-500">
            ...
            >
              {language==='English'?"Start registering a account":'点我注册账号'}
            </a>
          </p>
        </div>
      </div>
